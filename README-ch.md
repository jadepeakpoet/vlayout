...
版本请参考 [release 说明](https://github.com/jadepeakpoet/vlayout/releases)里的最新版本，最新的 aar 都会发布到 jitpack 上，确保配置了仓库源，然后引入依赖：
...
[Demo工程](https://github.com/jadepeakpoet/vlayout/tree/master/examples)
